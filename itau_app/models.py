...
class AboutUs(models.Model):
    ...
    imageauditors = models.ImageField(upload_to='about_us_images/', null=True, blank=True)
...
class BlogPost(models.Model):
    ...
    subImage = models.ImageField(upload_to='blog_images/', null=True, blank=True)
    subImage2 = models.ImageField(upload_to='blog_images/', null=True, blank=True)
...
class OurTeam(models.Model):
    ...
    image = models.ImageField(upload_to='ourTeam_images/', null=True, blank=True)
